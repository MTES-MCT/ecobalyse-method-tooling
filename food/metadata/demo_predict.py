...
def main():
    ...
    table.add_column("cropGroup", style="magenta", no_wrap=True, max_width=15)
    table.add_column("%", style="magenta", justify="right", max_width=4)
    # Density group (blue)
    table.add_column("density", style="blue", justify="right", max_width=8)
    table.add_column("match", style="blue", no_wrap=True, max_width=15)
    table.add_column("%", style="blue", justify="right", max_width=4)
    # Inedible group (red)
    table.add_column("inedible", style="red", justify="right", max_width=8)
    table.add_column("match", style="red", no_wrap=True, max_width=15)
    table.add_column("%", style="red", justify="right", max_width=4)
    # Ratio group (white/default)
    table.add_column("c/raw", justify="right", max_width=8)
